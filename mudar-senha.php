...
<head>
    ...
    <title>Alterar Senha - MetodoLOGICO</title>
    <link rel="stylesheet" href="bootstrap/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" media="screen" href="_css/mudar-senha.css">
...
<noscript>
    ...
    <div class="container">
        ...
        <form action='servidor/mudarsenha.php' method="POST" onsubmit="return validar()">
                <div class="col col-lg-12 col-md-12 col-sm-12 mt-2 form-group div-perguntas">
                    <div class="form-row">

                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label for='psw'><p>Senha</p></label>
                         <input type="password" name="psw" class='form-control usr' id="psw" minlength="6" required>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col form-group">
                            <label for="rpt-psw">Confirmar Senha</label>
                            <input type="password" name="rpt-psw" class='form-control' id="rpt-psw" minlength="6" required>  
                        </div>
                    </div>
        ...
        <script src="_js/mudar-senha.js"></script>
