...
echo 'aaaa' . $respostacorreta;
    ...
    $sql = "INSERT INTO `answers`(`question`, `ans1`, `ans2`, `ans3`, `ans4`,`correctans`, `time` ,`userID` ) VALUES ('". $pergunta . "', '" . $resposta1 . "', '" . $resposta2 . "' , '" . $resposta3 . "', '" . $resposta4 . "', " . $respostacorreta . ", " . $tempo . ", " . $userid . ")";
    if(!$con){
